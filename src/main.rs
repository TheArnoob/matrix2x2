...
fn main() {
    ...
    println!("Inverse of matrix a: {}", mat_a.inv());
    println!("Determinant of matrix b: {}", mat_b.det());
    println!("Inverse of matrix b: {}", mat_b.inv());
    println!("Determinant of matrix c: {}", mat_c.det());
    println!("Inverse of matrix c: {}", mat_c.inv());
    println!("Determinent of matrix d: {}", mat_d.det());
